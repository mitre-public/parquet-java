...
public class TestSchemaConverter {
  ...
  private final MessageType complexParquetSchema = Types.buildMessage()
      ...
      .addField(
          Types.optional(FIXED_LEN_BYTE_ARRAY).length(12).as(INTERVAL).named("m"))
      .named("root");
  ...
  private final MessageType allTypesParquetSchema = Types.buildMessage()
      ...
      .addField(
          Types.optional(FIXED_LEN_BYTE_ARRAY).length(12).as(INTERVAL).named("o"))
      .addField(
          Types.optional(FIXED_LEN_BYTE_ARRAY).length(12).as(INTERVAL).named("o1"))
  ...
  public void testParquetInt32TimeMillisToArrow() {
    MessageType parquet = Types.buildMessage()
        .addField(Types.optional(INT32).as(TIME_MILLIS).named("a"))
        .named("root");
  ...
  public void testParquetInt64TimeMicrosToArrow() {
    MessageType parquet = Types.buildMessage()
        .addField(Types.optional(INT64).as(TIME_MICROS).named("a"))
        .named("root");
  ...
  public void testParquetInt64TimeMillisToArrow() {
    converter.fromParquet(Types.buildMessage()
        .addField(Types.optional(INT64).as(TIME_MILLIS).named("a"))
        .named("root"));
  }
  ...
  public void testParquetInt32TimeMicrosToArrow() {
    converter.fromParquet(Types.buildMessage()
        .addField(Types.optional(INT32).as(TIME_MICROS).named("a"))
        .named("root"));
  }
  ...
  public void testArrowTimestampMillisecondToParquet() {
    ...
    Assert.assertEquals(
        expected,
        Types.buildMessage()
            .addField(Types.optional(INT64).as(TIMESTAMP_MILLIS).named("a"))
            .named("root"));
  }
  ...
  public void testArrowTimestampMicrosecondToParquet() {
    ...
    Assert.assertEquals(
        expected,
        Types.buildMessage()
            .addField(Types.optional(INT64).as(TIMESTAMP_MICROS).named("a"))
            .named("root"));
  }
  ...
  public void testParquetInt32TimestampMillisToArrow() {
    converter.fromParquet(Types.buildMessage()
        .addField(Types.optional(INT32).as(TIMESTAMP_MILLIS).named("a"))
        .named("root"));
  }
  ...
  public void testParquetInt32TimestampMicrosToArrow() {
    converter.fromParquet(Types.buildMessage()
        .addField(Types.optional(INT32).as(TIMESTAMP_MICROS).named("a"))
        .named("root"));
  }
}
