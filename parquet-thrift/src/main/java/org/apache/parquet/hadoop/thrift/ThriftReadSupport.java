...
public class ThriftReadSupport<T> extends ReadSupport<T> {
  ...
  private static <T> ThriftRecordConverter<T> getRecordConverterInstance(
    ...
    try {
      ...
      try {
        Constructor<ThriftRecordConverter<T>> constructor = converterClass.getConstructor(
            Class.class, MessageType.class, StructType.class, Configuration.class);
      ...
      throw new RuntimeException(
          "Cannot access constructor for Thrift converter class: " + converterClassName, e);
